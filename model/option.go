...
func InitOptionMap() {
	...
	common.OptionMap["OriginalModelPrice"] = ratio_setting.OriginalModelPrice2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "OriginalModelPrice":
		err = ratio_setting.UpdateOriginalModelPriceByJSONString(value)
	case "GroupRatio":
