...
type Midjourney struct {
	...
	BillingUserId int    `json:"-" gorm:"column:billing_user_id;index"`
...
func (m *Midjourney) GetBillingUserId() int {
	if m.BillingUserId > 0 {
		return m.BillingUserId
	}
	return ResolveBillingUserId(m.UserId)
}
