...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/export", permission: authz.ChannelSensitiveWrite, handler: controller.ExportChannels},
	{method: http.MethodPost, path: "/export", permission: authz.ChannelSensitiveWrite, handler: controller.ExportChannels},
	{method: http.MethodPost, path: "/import", permission: authz.ChannelSensitiveWrite, handler: controller.ImportChannels},
